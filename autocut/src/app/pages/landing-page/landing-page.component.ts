  ...
  team = [
    {
      ...
      role: 'Technical Lead',
      image: 'https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?w=600&auto=format'
    },
    {
      name: 'Emerson Hidalgo',
      role: 'Proyect Manager',
      image: 'https://images.unsplash.com/photo-1531590878845-12627191e687?w=600&auto=format'
    },
    {
      name: 'Luis Diego Dien',
      role: 'DevOps',
      image: 'https://images.unsplash.com/photo-1488508872907-592763824245?w=600&auto=format'
    },
    {
      name: 'Sebastian Zamora',
      role: 'Testing',
      image: 'https://images.unsplash.com/photo-1570295999919-56ceb5ecca61?w=600&auto=format'
    },
    {
      name: 'Gabriel Bryan',
      role: 'Testing',
      image: 'https://images.unsplash.com/photo-1499470932971-a90681ce8530?w=600&auto=format'
    }
  ];
 ...
 sendEmail(event: Event): void {
  ...
  emailjs
    ...
    .then(() => {
      ...
      this.successMessage = '✅ Mensaje enviado con éxito. ¡Gracias por contactarnos!';
      (event.target as HTMLFormElement).reset();
    })
    .catch((error: any) => {
      console.error('Error al enviar el mensaje:', error);
      this.isSending = false;
      this.errorMessage = '❌ Ocurrió un error al enviar el mensaje. Inténtalo más tarde.';
    });
}
